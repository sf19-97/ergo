...
pub enum ValidationError {
    WrongKind { expected: PrimitiveKind, got: PrimitiveKind },
    SideEffectsNotAllowed,
    NonDeterministicExecution,
    DuplicateId(String),
    InvalidInputType { input: String, expected: ValueType, got: ValueType },
    ...
    InvalidParameterType { parameter: String, expected: ValueType, got: ValueType },
